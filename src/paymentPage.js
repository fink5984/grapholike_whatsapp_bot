...
<script>
  ...
  function startHeightPolling() {
    ...
    // אחרי 12 שניות בלי תשובה — האייפרם לא נטען. בלי תקשורת איתו אי אפשר
    // לסלוק, אז מציגים הסבר במקום כפתור תשלום מושבת.
    setTimeout(function () {
      if (heightReceived || finished) return;
      frameLoading.innerHTML =
        '<div style="text-align:center;padding:14px">' +
        '<div style="font-size:15px;font-weight:700;color:#3b2063;margin-bottom:6px">טופס התשלום לא נטען</div>' +
